...
def _is_mortgage_related(text: str) -> bool:
    keywords = [
        ...
        "closing", "closing day", "clear to close", "settlement",
        ...
        "escrow", "title", "appraisal", "underwriting",
        "conforming", "conventional", "jumbo", "usda", "va",
        "interest rate", "fixed rate", "adjustable rate", "arm",
        "mortgage rate", "loan estimate", "cash-out", "cash out",
        "investor loan", "rental income", "hard money", "bridge loan",
